...
data:
  ...
  lifeexpect: life expectancy dataset
      parameters.json: JSON file with parameters for the life expectancy data
      data.csv: CSV file with cross-country life expectancy data.